...
# 👉 在這裡貼上你的履歷文字
resume_text = """
我的名字是蔡昀潔，來自中央大學資管系，我在 10 多個 Web 專案中累積了前後端整合、系統架構設計與效能優化的經驗。對資安的興趣也讓我深入理解攻防思維並將其應用於開發安全應用上。具備良好抗壓能力與溝通協作技巧，適應快速變動的開發節奏，喜歡參與 Hackathon 和團隊合作。

目前希望能加入 LINE 擔任 DevOps 或 Sticker/Factchecker Dev Intern職位，參與前後端開發、CI/CD、測試與產品設計，並優化系統架構與前端體驗。

【技能】
- 前端：Vue.js, Nuxt.js, JavaScript, TypeScript
...
【專案經驗】
NCU 
- 網址:https://24.ncufresh.ncu.edu.tw/
...
發票醫生：AI 財務應用
- 網址:https://invoice-doctor-dev.finctory.com/
...
# - 設定與管理 DHCP、VLAN、Firewall 與 NAT 規則、路由器設置
...
【競賽與成就】
- 2024 SITCON x Hackathon (LINE主題)
- 2024臺北秋季程式設計節城市通微服務大黑客松決賽
- InnoServe Awards -敏捷開發 入圍
...
我擅長用技術創造解決方案，也樂於學習新領域，擅長查資料，未來希望能在 LINE 的開發平台上實現更多跨系統的創新整合。
"""
...
def handle_message(event):
    ...
    messages = [
        {
            "role": "system",
            "content": "你是一位人資助理，請根據以下履歷用『第一人稱』的語氣回答使用者的問題，像是我本人在回答，對方是會想要了解我的面試官，向他們推銷我，語氣專業有禮貌。"
        },
